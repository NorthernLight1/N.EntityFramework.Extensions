...
namespace N.EntityFramework.Extensions
{
    public static class DatabaseExtensionsAsync
    {
        ...
        internal async static Task<int> CloneTableAsync(this Database database, string sourceTable, string destinationTable, IEnumerable<string> columnNames, string internalIdColumnName = null)
        {
            ...
            return await database.ExecuteSqlCommandAsync(string.Format("SELECT TOP 0 {0} INTO {1} FROM {2}", columns, destinationTable, sourceTable));
        }
